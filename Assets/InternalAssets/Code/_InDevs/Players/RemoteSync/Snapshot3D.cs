...
namespace ProjectOlog.Code._InDevs.Players.RemoteSync
{
    ...
    public struct Snapshot3D : Snapshot
    {
        ...
        public Snapshot3D(double remoteTime, double localTime, Vector3 position, Quaternion rotation, float viewPitchDegrees, bool isGrounded, ECharacterBodyState characterBodyState)
        {
