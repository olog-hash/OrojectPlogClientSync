...
namespace ProjectOlog.Code.Features.Players.Interpolation
{
    public class RemotePlayerInterpolation : MonoBehaviour
    {
        ...
        // <servertime, snaps>
        public SortedList<double, RemotePlayerInterpolationSnapshot> snapshots = new SortedList<double, RemotePlayerInterpolationSnapshot>();
        ...
        public void OnMessage(RemotePlayerInterpolationSnapshot snap)
        {
            ...
            if (snapshots.Count > 0)
            {
                ...
                if (interpolate)
                {
                    ...
                    SnapshotInterpolation.Step(
                        ...
                        ref localTimeline,
                        localTimescale,
                        out RemotePlayerInterpolationSnapshot fromSnapshot,
                        out RemotePlayerInterpolationSnapshot toSnapshot,
                        out double t);

                    // interpolate & apply
                    RemotePlayerInterpolationSnapshot computed = RemotePlayerInterpolationSnapshot.Interpolate(fromSnapshot, toSnapshot, t);
                ...
                {
                    RemotePlayerInterpolationSnapshot snap = snapshots.Values[0];
        ...
        public void SetPositionAndRotation(Vector3 position, Quaternion rotation)
        {
            ...
            foreach (KeyValuePair<double, RemotePlayerInterpolationSnapshot> snapshot in snapshots)
            {
