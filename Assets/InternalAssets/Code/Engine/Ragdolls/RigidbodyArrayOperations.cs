...
namespace ProjectOlog.Code.Engine.Ragdolls
{
    public class RigidbodyArrayOperations : MonoBehaviour
    {
        ...
        [SerializeField] private List<Rigidbody> rigidbodies = new (16);
        ...
        [Button(RefreshComponentsMethodTitle)]
