...
namespace ProjectOlog.Code.Engine.Characters.KinematicCharacter.Interpolation
{
    /// <summary>
    /// Система, сохраняющая текущий трансформ как предыдущий на каждом фиксированном обновлении.
    /// Подготавливает данные для последующей интерполяции.
    /// </summary>
    ...
    /// <summary>
    /// Система, выполняющая визуальную интерполяцию персонажа между физическими обновлениями.
    /// Интерполирует позицию и вращение для обеспечения плавного движения.
    /// </summary>
    [Il2CppSetOption(Option.NullChecks, false)]
    [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
    [Il2CppSetOption(Option.DivideByZeroChecks, false)]
