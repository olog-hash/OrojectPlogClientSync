...
namespace ProjectOlog.Code.Engine.Inputs
{
    /// <summary>
    /// Централизованная система управления вводом.
    /// Обеспечивает абстракцию над Unity Input System и поддерживает режимы от первого/третьего лица.
    /// </summary>
    public class InputControls
    {
        // Константы имен осей ввода
        private const string Horizontal = "Horizontal";
        private const string Vertical = "Vertical";
        private const string MouseX = "Mouse X";
        private const string MouseY = "Mouse Y";

        // Флаги состояния системы ввода
        ...
        // Словарь сопоставления типов клавиш с клавишами Unity
