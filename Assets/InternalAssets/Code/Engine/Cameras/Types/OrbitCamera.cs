...
{
    /// <summary>
    /// Управляет орбитальным движением камеры вокруг цели.
    /// Обеспечивает зум, вращение, обнаружение препятствий и следование за целью.
    /// </summary>
    public class OrbitCamera : MonoBehaviour
    {
        ...
        public void SetFollowTransform(UnityEngine.Transform t)
        {
            FollowTransform = t;
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            ...
            // В любом случае используем _lastKnownPosition как точку слежения
            {
                ...
                UnityEngine.Transform targetEntity = FollowTransform;
